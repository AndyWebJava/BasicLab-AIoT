...
#### Vehicle tracking/license plate recognition (e.g. fugitive)
<image src=".image/image/car.jpg" controls="" height=350 width=800> </image>

#### Cross camera risk personnel tracking (e.g. rioters)
<image src=".image/image/fengxian.jpg" controls="" height=350 width=800> </image>

#### Train stations, airplane stations, park access control/gate machines (such as spies)
<image src=".image/image/jiandie.jpg" controls="" height=400 width=1000> </image>

#### Real time facial comparison for security (such as fugitives)
