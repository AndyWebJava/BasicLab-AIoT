...
> Charging is to provide better service and also a greater incentive for authors. Three days after joining the planet, users can send me a private message and leave their WeChat ID, and I will invite everyone to join the group. If you are not satisfied within three days of joining, you can directly get a refund. You don't need to worry, and it's not impossible to come for free for three days.
...
This project has its own code that uses the loose MIT license and can be freely applied to both commercial and non-commercial projects while retaining copyright information. However, this project also sporadically used some other open source code. Please replace or remove it yourself for commercial use; Any commercial disputes or infringement arising from the use of this project are not related to this project or its developers. Please bear legal risks on your own. When using the code of this project, the authorization agreement should also indicate the protocols of the third-party libraries that this project relies on