...
import com.basiclab.iot.link.api.factory.RemoteDeviceFallbackFactory;
 ...
 * @author shisen
 */
@FeignClient(contextId = "remoteDeviceService", value = ServiceNameConstants.basiclabiot_LINK, fallbackFactory = RemoteDeviceFallbackFactory.class)
