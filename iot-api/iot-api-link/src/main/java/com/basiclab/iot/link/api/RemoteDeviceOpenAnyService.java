...
import com.basiclab.iot.link.api.domain.device.vo.param.*;
...
import com.basiclab.iot.link.api.factory.RemoteDeviceOpenAnyFallbackFactory;
 ...
 * @author shisen
 */
@FeignClient(contextId = "remoteDeviceOpenService", value = ServiceNameConstants.basiclabiot_LINK, fallbackFactory = RemoteDeviceOpenAnyFallbackFactory.class)
