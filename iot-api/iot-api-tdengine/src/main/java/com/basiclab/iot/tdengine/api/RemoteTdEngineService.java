package com.basiclab.iot.tdengine.api;
...
import com.basiclab.iot.tdengine.api.factory.RemoteTdEngineFallbackFactory;
...
@FeignClient(contextId = "remoteTdEngineService", value = ServiceNameConstants.basiclabiot_TDENGINE, fallbackFactory = RemoteTdEngineFallbackFactory.class, path = "/dataOperation")
