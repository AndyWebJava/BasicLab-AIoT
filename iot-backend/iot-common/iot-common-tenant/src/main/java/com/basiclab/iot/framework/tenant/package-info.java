 ...
 *      1）Spring Async：
 *          {@link com.basiclab.iot.framework.quartz.config.YudaoAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 ...
 *
 */
package com.basiclab.iot.framework.tenant;
