package com.basiclab.iot.framework.desensitize.core;

import com.basiclab.iot.framework.common.util.json.JsonUtils;
import com.basiclab.iot.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.basiclab.iot.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.basiclab.iot.framework.desensitize.core.annotation.Address;
import com.basiclab.iot.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import com.basiclab.iot.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import com.basiclab.iot.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
import com.basiclab.iot.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import com.basiclab.iot.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import com.basiclab.iot.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import com.basiclab.iot.framework.desensitize.core.slider.annotation.MobileDesensitize;
import com.basiclab.iot.framework.desensitize.core.slider.annotation.SliderDesensitize;
import lombok.Data;
