package com.basiclab.iot.framework.websocket.config;

import com.basiclab.iot.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import com.basiclab.iot.framework.mq.redis.core.RedisMQTemplate;
import com.basiclab.iot.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.basiclab.iot.framework.websocket.core.listener.WebSocketMessageListener;
import com.basiclab.iot.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.basiclab.iot.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.basiclab.iot.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.basiclab.iot.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.basiclab.iot.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.basiclab.iot.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.basiclab.iot.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.basiclab.iot.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.basiclab.iot.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.basiclab.iot.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.basiclab.iot.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.basiclab.iot.framework.websocket.core.session.WebSocketSessionManager;
import com.basiclab.iot.framework.websocket.core.session.WebSocketSessionManagerImpl;
