...
@Schema(description = "管理后台 - 产品模型事件响应新增/修改 Request VO")
@Data
public class ProductEventResponseSaveReqVO {

    @Schema(description = "id", requiredMode = Schema.RequiredMode.REQUIRED, example = "26706")
    private Long id;

    @Schema(description = "事件id", requiredMode = Schema.RequiredMode.REQUIRED, example = "19391")
    ...
    @NotEmpty(message = "指示数据类型。取值范围：string、int、decimal不能为空")
