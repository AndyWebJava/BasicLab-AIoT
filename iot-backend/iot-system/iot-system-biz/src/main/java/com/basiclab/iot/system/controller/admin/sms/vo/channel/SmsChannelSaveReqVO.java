...
public class SmsChannelSaveReqVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "BasicLab源码")
    ...
    @Schema(description = "短信发送回调 URL", example = "https://gitee.com/vegetable-chicken-blog/basiclab-iot")
