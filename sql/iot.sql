...
VALUES ('mqttsScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', NULL,
        'com.basiclab.iot.job.util.QuartzDisallowConcurrentExecution', '0', '1', '0', '0',
...
VALUES ('mqttsScheduler', 'TASK_CLASS_NAME10', 'RULE_TRIGGER', NULL,
        'com.basiclab.iot.job.util.QuartzJobExecution', '0', '0', '0', '0',
...
INSERT INTO `gen_table` (`table_id`, `table_name`, `table_comment`, `sub_table_name`, `sub_table_fk_name`, `class_name`,
                         ...
                         `update_time`, `remark`)
VALUES (3, 'device', '设备管理', '', '', 'Device', 'crud', 'com.basiclab.iot.link', 'link', 'device', '设备管理',
...
INSERT INTO `gen_table` (`table_id`, `table_name`, `table_comment`, `sub_table_name`, `sub_table_fk_name`, `class_name`,
                         ...
                         `function_author`, `gen_type`, `gen_path`, `options`, `create_by`, `create_time`, `update_by`,
                         `update_time`, `remark`)
VALUES (4, 'product', '产品管理', NULL, NULL, 'Product', 'crud', 'com.basiclab.iot.link', 'link', 'product',
        '产品管理',
...
INSERT INTO `gen_table` (`table_id`, `table_name`, `table_comment`, `sub_table_name`, `sub_table_fk_name`, `class_name`,
                         ...
                         `function_author`, `gen_type`, `gen_path`, `options`, `create_by`, `create_time`, `update_by`,
                         `update_time`, `remark`)
VALUES (5, 'device_info', '子设备档案表', '', '', 'DeviceInfo', 'crud', 'com.basiclab.iot.link', 'link',
        'deviceInfo',
        '子设备管理', 'basiclabiot', '0', '/',
...
INSERT INTO `gen_table` (`table_id`, `table_name`, `table_comment`, `sub_table_name`, `sub_table_fk_name`, `class_name`,
                         ...
                         `function_author`, `gen_type`, `gen_path`, `options`, `create_by`, `create_time`, `update_by`,
                         `update_time`, `remark`)
VALUES (7, 'casbin_rule', 'CAS规则策略配置表', NULL, NULL, 'CasbinRule', 'crud', 'com.basiclab.iot.link', 'link',
...
INSERT INTO `gen_table` (`table_id`, `table_name`, `table_comment`, `sub_table_name`, `sub_table_fk_name`, `class_name`,
                         ...
                         `function_author`, `gen_type`, `gen_path`, `options`, `create_by`, `create_time`, `update_by`,
                         `update_time`, `remark`)
VALUES (8, 'device_topic', '设备Topic数据表', '', '', 'DeviceTopic', 'crud', 'com.basiclab.iot.link', 'link',
        'topic',
...
INSERT INTO `gen_table` (`table_id`, `table_name`, `table_comment`, `sub_table_name`, `sub_table_fk_name`, `class_name`,
                         ...
                         `function_author`, `gen_type`, `gen_path`, `options`, `create_by`, `create_time`, `update_by`,
                         `update_time`, `remark`)
VALUES (9, 'device_action', '设备动作数据', NULL, NULL, 'DeviceAction', 'crud', 'com.basiclab.iot.link', 'link',
...
INSERT INTO `gen_table` (`table_id`, `table_name`, `table_comment`, `sub_table_name`, `sub_table_fk_name`, `class_name`,
                         ...
                         `function_author`, `gen_type`, `gen_path`, `options`, `create_by`, `create_time`, `update_by`,
                         `update_time`, `remark`)
VALUES (10, 'device_location', '设备位置表', NULL, NULL, 'DeviceLocation', 'crud', 'com.basiclab.iot.link',
        'link',
...
INSERT INTO `gen_table` (`table_id`, `table_name`, `table_comment`, `sub_table_name`, `sub_table_fk_name`, `class_name`,
                         ...
                         `function_author`, `gen_type`, `gen_path`, `options`, `create_by`, `create_time`, `update_by`,
                         `update_time`, `remark`)
VALUES (11, 'product_template', '产品模板', NULL, NULL, 'ProductTemplate', 'crud', 'com.basiclab.iot.link',
        'link',
...
INSERT INTO `gen_table` (`table_id`, `table_name`, `table_comment`, `sub_table_name`, `sub_table_fk_name`, `class_name`,
                         ...
                         `function_author`, `gen_type`, `gen_path`, `options`, `create_by`, `create_time`, `update_by`,
                         `update_time`, `remark`)
VALUES (12, 'protocol', '协议信息表', NULL, NULL, 'Protocol', 'crud', 'com.basiclab.iot.link', 'link',
        'protocol',
...
INSERT INTO `gen_table` (`table_id`, `table_name`, `table_comment`, `sub_table_name`, `sub_table_fk_name`, `class_name`,
                         ...
                         `function_author`, `gen_type`, `gen_path`, `options`, `create_by`, `create_time`, `update_by`,
                         `update_time`, `remark`)
VALUES (13, 'rule', '规则信息表', NULL, NULL, 'Rule', 'crud', 'com.basiclab.iot.link', 'link', 'rule',
        '规则信息',
...
VALUES (100, 0, '0', 'iot', 0, 'basiclabiot', '15888888888', 'iot@163.com', '0', '0', 'admin',
...
INSERT INTO `sys_user` (`user_id`, `dept_id`, `user_name`, `nick_name`, `user_type`, `email`, `phonenumber`, `sex`,
                        ...
                        `create_time`, `update_by`, `update_time`, `remark`)
VALUES (1, 103, 'admin', 'admin', '00', 'iot@163.com', '15888888889', '0',
...
INSERT INTO `sys_user` (`user_id`, `dept_id`, `user_name`, `nick_name`, `user_type`, `email`, `phonenumber`, `sex`,
                        `avatar`, `password`, `status`, `del_flag`, `login_ip`, `login_date`, `create_by`,
                        `create_time`, `update_by`, `update_time`, `remark`)
VALUES (3, 100, 'basiclabiot', 'basiclabiot', '00', 'iot@qq.com', '', '0', NULL,
