...
import com.basiclab.iot.common.core.enums.DeviceTopicEnum;
...
import com.basiclab.iot.link.api.domain.device.model.DeviceParams;
import com.basiclab.iot.link.api.domain.device.vo.param.TopoDeviceDataReportParam;
import com.basiclab.iot.link.api.domain.device.vo.param.TopoQueryDeviceParam;
import com.basiclab.iot.link.api.domain.device.vo.result.TopoDeviceOperationResultVO;
import com.basiclab.iot.link.api.domain.device.vo.result.TopoQueryDeviceResultVO;
...
import com.basiclab.iot.link.mapper.device.DeviceMapper;
