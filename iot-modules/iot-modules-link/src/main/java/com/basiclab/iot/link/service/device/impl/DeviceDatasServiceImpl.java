...
import com.basiclab.iot.link.mapper.device.DeviceDatasMapper;
import com.basiclab.iot.link.service.device.DeviceDatasService;
...
import com.basiclab.iot.common.core.enums.DeviceType;
import com.basiclab.iot.common.core.enums.ProtocolType;
...
import com.basiclab.iot.common.core.utils.SubStringUtil;
import com.basiclab.iot.common.core.utils.tdengine.TdUtils;
...
import com.basiclab.iot.link.api.domain.device.model.DeviceInfos;
import com.basiclab.iot.link.api.domain.device.model.TopoAddDatas;
...
import com.basiclab.iot.tdengine.api.domain.Fields;
import com.basiclab.iot.tdengine.api.domain.SuperTableDto;
import com.basiclab.iot.tdengine.api.domain.model.TableDTO;
...
public class DeviceDatasServiceImpl implements DeviceDatasService {
     ...
     * 数据库名称
     */
    @Value("${spring.datasource.dynamic.datasource.master.dbName:basiclabiot}")
    ...
    public void insertBaseDatas(JSONObject basiclabiotMessage) throws Exception {
        String topic = basiclabiotMessage.getString("topic");
        String qos = basiclabiotMessage.getString("qos");
        String body = basiclabiotMessage.getString("body");
        String time = basiclabiotMessage.getString("time");
