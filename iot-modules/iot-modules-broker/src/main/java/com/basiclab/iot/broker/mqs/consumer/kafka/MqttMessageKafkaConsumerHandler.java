...
public class MqttMessageKafkaConsumerHandler {
     ...
     */
    @KafkaListener(topics = {ConsumerTopicConstant.Mqtt.basiclabiot_MQS_MQTT_MSG,
            ConsumerTopicConstant.Mqtt.basiclabiot_MQTT_CLIENT_CONNECTED_TOPIC,
            ConsumerTopicConstant.Mqtt.basiclabiot_MQTT_CLIENT_DISCONNECTED_TOPIC,
            ConsumerTopicConstant.Mqtt.basiclabiot_MQTT_SERVER_CONNECTED_TOPIC,
            ConsumerTopicConstant.Mqtt.basiclabiot_MQTT_DEVICE_KICKED_TOPIC,
            ConsumerTopicConstant.Mqtt.basiclabiot_MQTT_SUBSCRIPTION_ACKED_TOPIC,
            ConsumerTopicConstant.Mqtt.basiclabiot_MQTT_UNSUBSCRIPTION_ACKED_TOPIC,
            ConsumerTopicConstant.Mqtt.basiclabiot_MQTT_DISTRIBUTION_ERROR_TOPIC,
            ConsumerTopicConstant.Mqtt.basiclabiot_MQTT_DISTRIBUTION_COMPLETED_TOPIC,
            ConsumerTopicConstant.Mqtt.basiclabiot_MQTT_PING_REQ_TOPIC
